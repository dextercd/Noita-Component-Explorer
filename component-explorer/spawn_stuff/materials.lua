...
return function()
    ...
    _, filter_material_type = combo.optional("Material Type", unique_material_types, filter_material_type)
    ...
    imgui.SetNextItemWidth(150)
    _, container_choice = combo.optional("Spawn Container", container_options, container_choice, "--Depends--")
